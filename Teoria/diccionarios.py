...
#Método popitem(): Elimina un elemento por su clave y devuelve el último par clave-valor insertado en el diccionario. La salida de este par será una tupla. Si el diccionario esta vacio, nos va arrojar un KeyError
...
print("\nDiccionario uno con nuevos elementos:", diccionario_uno)
...
valor_setdefault_dos = diccionario_uno.setdefault('h')
